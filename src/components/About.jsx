  ...
  return (
    ...
    >
      ...
      <div className=" w-full">
        <div className="w-full h-full flex flex-col justify-center items-start gap-3 lg:p-20 p-4 text-primary">
          <h1 className="text-[22px] leading-[30px] tracking-[2px] font-azahra mb-5 px-4 2xl:px-12 text-secondary">
            {t("about.title")}
          </h1>
          <p className="text-[14px] font-light lg:font-normal text-justify tracking-wider leading-[28px] px-4 2xl:px-12">
            {t("about.content_1")}
          </p>
          <p className="text-[14px] font-light lg:font-normal text-justify tracking-wider leading-[28px] px-4 2xl:px-12 ">
            {t("about.content_2")}
